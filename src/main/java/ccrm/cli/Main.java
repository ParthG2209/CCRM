...
public class Main {
    public static void main(String[] args) {
        ...
        EnrollmentService enrollmentService = new EnrollmentService(enrollmentRepo, studentRepo, offeringRepo);

        CLIController cli = new CLIController(studentService, courseService, enrollmentService);
        cli.run();
    }
}
